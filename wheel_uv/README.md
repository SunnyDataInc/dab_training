...
The 'wheel_uv' project was generated by using the DAB **default-python** template.
There are two wheels created by this bundle, managed by `UV` and both are installed in the job cluster created by the bundle.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] wheel_uv_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/wheel_uv.job.yml). The schedule
